...
btimes, bpos = loadData('{}swimheight_light_5cm_Scale50pc.pickle'.format(prepend), lowerbound, upperbound)
lowerbound, upperbound = 0, 5
ctimes, cpos = loadData('{}swimheight_light_5cm_Scale100pc.pickle'.format(prepend), lowerbound, upperbound)
lowerbound, upperbound = 0, 5
dtimes, dpos = loadData('{}swimheight_light_5cm_Scale150pc.pickle'.format(prepend), lowerbound, upperbound)
